...
const WashingmachineSubSchema = new mongoose.Schema(
  {
...
const WashingmachineSchema = new mongoose.Schema(
  {
    LG_washingmachine: [WashingmachineSubSchema], 
    Samsung_washingmachine: [WashingmachineSubSchema],
    Whirlpool_washingmachine: [WashingmachineSubSchema],
    Godrej_washingmachine: [WashingmachineSubSchema],
    IFB_washingmachine: [WashingmachineSubSchema],
  },
  { _id: true },
  {
    timestamps: true, 
